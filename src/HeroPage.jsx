...
function HeroPage() {
  ...
  // ✅ Updated sendMail with full validation + clean email message
...
Message: ${message}
    ...
    emailjs
      .send("service_o0ryjxg", "template_d0wua58", parms)
      .then(() => {
        setloading(false);
          ...
          <div className="w-full lg:w-[45%] px-4 lg:px-0 py-6 lg:py-0">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start lg:h-[19vh] mt-6">
              ...
              <div className='ml-0 lg:ml-4 mt-4 lg:mt-0 text-center lg:text-left'>
                ...
                <h5 className='text-[#a3a3a3] text-[14px] mb-1'> Java | JavaScript | SQL | MERN Stack </h5>
                <div
                  ...
                  onClick={() => window.open('https://drive.google.com/file/d/1yzmLF3QbQltmNHsVXn3aR9aYCt-4FUJ5/view?usp=sharing', '_blank')}
                >
              ...
              {[
                {
                  id: 1,
                  title: "DokJan",
                  description: "Built a MERN-based project management platform enabling secure document handling and real-time collaboration for 1,000+ users.",
                ...
                },
                {
                  id: 2,
                  title: "CryptoCraft",
                  description: "A crypto learning platform where users can buy coins at real-time prices, and track profits/losses.",
                ...
                },
                {
                  id: 3,
                  title: "WorthEat (Work)",
                  description: "Contributed to the development of WorthEat, a real-time mess management system.",
            ...
            <form className="max-w-sm mx-auto p-6 bg-[#18181b] rounded-2xl">
              <div className="mb-2">
                <input
                  ...
                  name="name"
                  required
                  className="w-full p-2 border border-[#4b4b4b] text-[13px] rounded-md shadow-sm 
            ...
            <div className="w-full flex justify-center mt-[-5px ]"><h1 className='text-white '>or</h1></div>
